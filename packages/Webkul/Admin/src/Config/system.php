...
return [
    ...
    'name'    => 'order_custom_status',
    'title'   => 'Özel Sipariş Durumu',
    'type'    => 'select',
    'options' => [
        [
            'title' => 'Tedarik Ediliyor',
            'value' => Order::CUSTOM_STATUS_TEDARIK,
        ],
        [
            'title' => 'Kutulanıyor',
            'value' => Order::CUSTOM_STATUS_KUTULAMA,
        ],
        [
            'title' => 'Kargoya Veriliyor',
            'value' => Order::CUSTOM_STATUS_KARGODA,
        ],
        [
            'title' => 'Yolda',
            'value' => Order::CUSTOM_STATUS_YOLDA,
        ],
        [
            'title' => 'Teslim Edildi',
            'value' => Order::CUSTOM_STATUS_TESLIM,
        ],
    ],
    'validation' => 'required',
],
