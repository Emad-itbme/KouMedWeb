                    ...
                    [
                        ...
                        'options'                => json_encode([
                            'services' => [
                                ...
                                [
                                    'title'         => trans('installer::app.seeders.shop.theme-customizations.services-content.title.warranty', [], $locale),
                                    'description'   => trans('installer::app.seeders.shop.theme-customizations.services-content.description.warranty-info', [], $locale),
                                    'service_icon'  => 'icon-warranty-alt',
                                ],
                            ],
                        ]),
                    ],
