...
class Order extends Model implements OrderContract
{
    ...
    public const CUSTOM_STATUS_TEDARIK = 'tedarik_ediliyor';
public const CUSTOM_STATUS_KUTULAMA = 'kutulaniyor';
public const CUSTOM_STATUS_KARGODA = 'kargoya_veriliyor';
public const CUSTOM_STATUS_YOLDA = 'yolda';
public const CUSTOM_STATUS_TESLIM = 'teslim_edildi';
