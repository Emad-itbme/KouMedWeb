...
export async function register(page) {
    ...
    await page.getByPlaceholder("email@Koume.com").click();
    await page.getByPlaceholder("email@Koume.com").fill(credentials.email);
...
export async function loginAsCustomer(page) {
    ...
    await page.getByPlaceholder("email@Koume.com").click();
    await page.getByPlaceholder("email@Koume.com").fill(credentials.email);
    await page.getByPlaceholder("email@Koume.com").press("Tab");
